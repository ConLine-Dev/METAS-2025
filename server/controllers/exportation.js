   ...
   listAllProcesses: async function(hash){
      ...
      let result = await executeQuerySQL(`
         SELECT
            ...
            Lhs.Numero_Processo,
            CASE 
               WHEN Lhs.Tipo_Carga = 1 /* Aéreo */ AND Lms.IdCompanhia_Transporte IN (88 /*FEDEX*/, 49339 /*DHL*/, 58828 /*UPS*/) THEN 'EA-COURIER'
               WHEN Lhs.Tipo_Carga = 1 /* Aéreo */ AND Lms.IdCompanhia_Transporte NOT IN (88 /*FEDEX*/, 49339 /*DHL*/, 58828 /*UPS*/) THEN 'EA-NORMAL'
               WHEN Lhs.Tipo_Carga = 3 /* FCL */ THEN 'EM-FCL'
               WHEN Lhs.Tipo_Carga = 4 /* LCL */ THEN 'EM-LCL'
